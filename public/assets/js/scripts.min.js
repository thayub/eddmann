...
t.content=tr.querySelector('p.e-entry-title').innerHTML.replace(/<\/?b[^>]*>/gi,'');t.isRetweet=!!tr.querySelector('.retweet-credit');t.retweets=tr.querySelector('span.stats-retweets')?parseInt(tr.querySelector('span.stats-retweets').innerText.replace(',',''),10):0;output.push(t);}
this.cb(output);};var tweets=new TweetFetch('354188847791366144');tweets.fetch(function(tweets)
